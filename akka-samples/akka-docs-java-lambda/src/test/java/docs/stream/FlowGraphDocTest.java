...
public class FlowGraphDocTest {
  ...
  public void demonstrateBuildSimpleGraph() {
    ...
    final Flow<Integer, Integer> f1 = Flow.<Integer>empty().map(elem -> elem + 10);
    final Flow<Integer, Integer> f2 = Flow.<Integer>empty().map(elem -> elem + 20);;
    final Flow<Integer, String> f3 = Flow.<Integer>empty().map(elem -> elem.toString());
    final Flow<Integer, Integer> f4 = Flow.<Integer>empty().map(elem -> elem + 30);;
  ...
  public void demonstrateReusingFlowInGraph() throws Exception {
    ...
    final Flow<Integer, Integer> sharedDoubler = Flow.<Integer>empty().map(elem -> elem * 2);
